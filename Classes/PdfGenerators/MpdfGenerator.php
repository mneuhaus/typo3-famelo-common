<?php
namespace Famelo\FameloCommon\PdfGenerators;
...
class MpdfGenerator implements PdfGeneratorInterface {
	...
	public function setOption($name, $value) {
		...
		if (!isset($this->options[$name])) {
			throw new \Exception('The option "' . $name . '" you\'re trying to set does not exist. This generator supports these options: ' . chr(10) . chr(10) . implode(chr(10), array_keys($this->options)), 1421314368);
		}
